    ...
    )
{
    ...
    WriteOutput("  RECV_OPER:             %llu\n", (unsigned long long)Counters[QUIC_PERF_COUNTER_RECV_OPER]);
    WriteOutput("  SEND_OPER:             %llu\n", (unsigned long long)Counters[QUIC_PERF_COUNTER_SEND_OPER]);
}
